...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		{
			mainLight.UseLight(0.1f, 1.0f, 0.1f, );
		...
		printf("mueveavatar %f", mueveAvatar01);
		if (mueveAvatar01 >= 20)
		{
			raidenCont01 += 1;
		}
		...
		printf("valor raiden c1 %d", raidenCont01);
		printf("valor raiden c2 %d", raidenCont02);
		// RAIDEN
